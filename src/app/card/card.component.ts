...
export class CardComponent {
  ...
  //   }
  // ]
  constructor(private router:Router , private  product_servie:ProductApiService,private cartService:CartServiceService){}
  productArrayData :any
  ...
  ngOnInit(){
  this.product_servie.getAllProduct().subscribe((res)=>this.productArrayData = res.products)
